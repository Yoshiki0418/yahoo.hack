...
function setupButtonListeners() {
    ...
    if (aiModeButton) {
        // 以前に追加されたリスナーを削除してから新しく追加
        // 注意: removeEventListenerは同じ関数を指定する必要がありますが、
        // ここではaiModeButtonClickHandlerが名前付き関数として定義されているため問題なく機能します。
        aiModeButton.removeEventListener('click', aiModeButtonClickHandler);
        aiModeButton.addEventListener('click', aiModeButtonClickHandler);
    }
}
