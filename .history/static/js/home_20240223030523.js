...
let currentIndex = 0; // グローバルスコープでcurrentIndexを定義
...
window.onload = function() {
  // movie_container_main クラスを持つ全ての要素を取得
  var containers = document.querySelectorAll('.movie_container_main');

  // 最初の要素が存在する場合、show クラスを追加して表示
