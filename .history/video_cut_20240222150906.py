...
def detect_and_crop_items_from_video(video_path, detection_interval=3, filename):
        ...
        if frame_count % (fps * detection_interval) == 0:
            ...
            for box, cls_id in zip(boxes, classes):
                ...
                if save_dir:
                    ...
                    cropped_image_path = os.path.join(base_dir, save_dir, f'{class_name}_{frame_count}.png')
